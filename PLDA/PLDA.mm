...
/**
 Perform inference and return an NSArray, where each entry is an NSArray containing a single NSNumber for each category, which is the expected number of words generated by that category.
 */
...
/**
 Using the generated model, return the top `numTags` words for category `category`. These are expected 
